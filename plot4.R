...
# Set the parameter for four different charts
par(mfrow = c(2, 2))
...
# Top Left
plot(data$Voltage~data$Date.Time, 
     type = "l", 
     xlab = "datatime",
     ylab = "Voltage", 
)
...
#Bottom Left
plot(data$Global_reactive_power~data$Date.Time, 
     type = "l", 
     xlab = "datetime",
...
dev.copy(png, file="plot4.png", width = 800, height = 500)
dev.off()